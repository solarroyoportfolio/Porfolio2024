  ...
  return (
    <footer className='bg-color_primary justify-center items-center text-center p-20 pb-32 flex-col'>
        ...
        <ul className='justify-center items-center text-center lg:flex mb-4 gap-8'>
            <li className='py-3 lg:py-2'><a href="#home">Home</a></li>
        ...
        <div className='flex justify-center items-center mb-4 gap-6'>
            <a href="https://www.linkedin.com/in/mariasolarroyoc/"
              target="_blank" className='bg-color_bg text-color_white p-3 rounded-lg'>
            <FaLinkedinIn />

            </a>
            <a href="https://github.com/MSolArroyo"  target="_blank" className='bg-color_bg text-color_white p-3 rounded-lg'>
            <FaGithub />

            </a>
            <a href="mailto:mariasolarroyoc@gmail.com"
              target="_blank" className='bg-color_bg text-color_white p-3 rounded-lg'>
