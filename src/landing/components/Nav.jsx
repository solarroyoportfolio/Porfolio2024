...
export const Nav = () => {
  ...
  return (
    <nav className="text-color_gray inline-flex  bg-[#0000004d] w-auto py-4 px-8 z-20 fixed bottom-8 justify-center items-center transform -translate-x-[50%] left-1/2 gap-6 rounded-[3rem] backdrop-blur-sm">
      <a
        onClick={() => setActive("#")}
